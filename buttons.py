...
def handle_fixed_button(action):
    ...
    the display. Stub implementations for now -- wire these up to your
    actual player daemon once it exists.
    """
    if action == "play_pause":
        print("[buttons] play/pause pressed (player not wired up yet)")
        # TODO: send play/pause command to player daemon
    elif action == "skip_next":
        print("[buttons] skip next pressed (player not wired up yet)")
        # TODO: send skip command to player daemon
    elif action == "skip_prev":
        print("[buttons] skip previous pressed (player not wired up yet)")
        # TODO: send skip command to player daemon
